...
import 'package:tubes_1/screens/Bangunan/bangunan_invoice.dart';

class FormPesanTukangScreenBangunan extends StatefulWidget {
  const FormPesanTukangScreenBangunan({super.key});

  @override
  State<FormPesanTukangScreenBangunan> createState() => _FormPesanTukangScreenState();
}

class _FormPesanTukangScreenState extends State<FormPesanTukangScreenBangunan> {
  int jumlahTukang = 1;
            ...
            Padding(
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (_) => const InvoiceScreenBangunan()),
                  );
                },
